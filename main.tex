...
& Advised by \href{https://www.salk.edu/scientist/rusty-gage/}{Fred H. Gage} and \href{https://cogsci.ucsd.edu/people/faculty/eran-mukamel.html}{Eran A. Mukamel} \\
& \\
...
& \textit{Job managers}: Cromwell, Sun Grid Engine (SGE), Slurm, PBS-Torque \\
& \textit{Cloud computing}: Google Cloud Platform (GCP), Terra \\
& \textit{Visualization}: ggplot, matplotlib, seaborn, plotly \\
& \\ 
